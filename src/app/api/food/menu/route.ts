...
export async function GET() {
  try {
    ...
    // Force re-seed and drop existing collection so it stays up-to-date with new fields (shop, location)
    await collection.deleteMany({});
    console.log("🥣 Reseeding food menu items with shop locations in MongoDB...");
    ...
    console.error("❌ [GET /api/food/menu] Error:", message);
